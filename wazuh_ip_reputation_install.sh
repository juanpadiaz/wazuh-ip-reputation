...
# Versión: 3.0.0 (con soporte para campos de red personalizables)
...
('database_version', '3.0.0', 'Versión del esquema de base de datos'),
...
#!/usr/bin/env python3
"""
Wazuh IP Reputation Checker v3.0.0
Analiza IPs de logs de Wazuh y verifica su reputación
Versión con campos de red personalizables
"""
...
class WazuhIPReputationChecker:
    def __init__(self, config_file: str = '/etc/wazuh-ip-reputation/config.ini'):
        ...
        self.logger.info("Wazuh IP Reputation Checker v3.0.0 iniciado")
...
Wazuh IP Reputation Checker v3.0.0
            ...
            <body>
                <div class="container">
                    ...
                    <div class="footer">
                        <p>Wazuh IP Reputation Checker v3.0.0</p>
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Wazuh IP Reputation Checker v3.0.0')
...
APPEOF
    ...
    log_success "Aplicación principal creada con soporte para campos personalizables"
}
...
show_summary() {
    ...
    echo -e "${GREEN}Versión 3.0.0 con campos personalizables instalada${NC}"
}
